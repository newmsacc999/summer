...
const OrderSummary = () => {
  ...
  return (
    <div className="bg-[#f1f3f6] min-h-screen flex flex-col">
      {/* Header */}
      ...
      <div className="w-full bg-white shadow-[0_-2px_10px_rgba(0,0,0,0.1)] p-3 hidden sm:flex z-40 justify-start items-center mx-auto left-0 right-0">
